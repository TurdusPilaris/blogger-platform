...
const getBlogsControllerByID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     .status(200)
    //      .send(foundBlog);
    const foundBlog = yield blogsMongoRepository_1.blogsMongoRepository.findForOutput(new mongodb_1.ObjectId(req.params.id));
    if (!foundBlog) {
        res.sendStatus(404);
    }
    res
